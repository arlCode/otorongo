...
<!-- <section id="main" class="homepage-area col-left">
  ...
  <?php if (have_rows('lodge')): ?>

    <?php while (have_rows('lodge')): the_row();
          $headline = get_sub_field('lodge_headline');
          $icon = get_sub_field('lodge_icon');
    ?>
      <div class="exp__wrap">
        ...
        <div class="exp__body">
          <div class="exp__content-wrap">
            <?php if (have_rows('lodge_text')): ?>
              <div class="exp__text">
                <?php while (have_rows('lodge_text')): the_row(); ?>
            ...
            <div class="exp__photos">
              <?php if (have_rows('lodge_photos')): ?>
                  <?php while (have_rows('lodge_photos')): the_row();$photo = get_sub_field('photo');
          ...
          <?php if (have_rows('lodge_callout')): ?>
            <div class="exp__callout-wrap">
              <?php while (have_rows('lodge_callout')): the_row();
