    ...
    <div id="content" class="col-full">
        ...
        <?php while (have_posts()) : the_post(); $count++; ?>
            ...
            <div <?php post_class(); ?>>
            	...
            	<div class="inner">
	                ...
	                <header><h1 class="top-title"><?php the_title(); ?></h1></header>
        ...
        <?php 
            ...
            if ( 'true' == $settings['business_display_features'] ) {
				...
				$args = array( 'title' => 'Otorongo Adventures', 'size' => 250, 'per_row' => 3, 'limit' => $settings['homepage_number_of_features'] );
            ...
            if ( 'true' == $settings['business_display_testimonials'] ) {
				...
				$args = array( 'title' => 'What others have to say', 'size' => 60, 'per_row' => 3, 'limit' => $settings['homepage_number_of_testimonials'] );
